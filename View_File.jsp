    ...
    <body>
        ...
        <div class="col-sm-7 col-xs-12 contact-right">
            <%
                ...
                String query = "SELECT * FROM owner_key";
                ResultSet i = db.Select(query);
            %> 

            <div class="form-details">
                <table cellpadding="55" style="margin-left: 53%; color: white;"border="2">
                    <tr>
                        <td><b>FILE_INDEX&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </b></td>
                        <td><b>FILE_CONTENT&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></td>
                        <td><b>OWNER_NAME&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </b></td>
                        <td><b>PUBLIC_KEY&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </b></td>
                    </tr>
                    <%
                    ...
                    <tr>
                        ...
                        <td><%=i.getString("ownername")%></td> 
                        <td><%=i.getString("pu_key")%></td>                           
                        <td><a  style ="color: white;" href="File_Upload.jsp?cid=<%=i.getInt("fid")%>&cname=<%=i.getString("fname")%>&coname=<%=i.getString("ownername")%>&ckey=<%=i.getString("pu_key")%>" style="width: 11%;">UPLOAD</a></td>
