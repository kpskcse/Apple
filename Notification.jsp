    ...
    <body>
                    ...
                    <div class="container">
                       ...
                       <div class="collapse navbar-collapse " id="bs-example-navbar-collapse-1">
                            ...
                            <ul class="nav navbar-nav nav-max-wid cl-effect-5" id="cl-effect-5">
                                ...
                                <li><a href="Notification.jsp"><span data-hover="NOTIFICATION" class="active">NOTIFICATION</span></a></li>
        ...
        <div class="col-sm-7 col-xs-12 contact-right">
            ...
            <div class="form-details" style="" >
                <table cellpadding="55" style="margin-left: 42%; color: white;"border="2">
                    <tr>
                        <td><b>FILE_INDEX&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </b></td>
                        <td><b>FILE_CONTENT&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></td>
                        <td><b>OWNER_NAME&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </b></td>
                        <td><b>SEMI_DEC_KEY&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></td>
                        <td><b>FILE_ACCESS_KEY&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </b></td>
                    </tr>
                    <%
