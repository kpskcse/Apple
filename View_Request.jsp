    ...
    <body>
                        ...
                        <!-- Collect the nav links, forms, and other content for toggling -->
                         <div class="collapse navbar-collapse " id="bs-example-navbar-collapse-1">
                            ...
                            <ul class="nav navbar-nav nav-max-wid cl-effect-5" id="cl-effect-5">
                                ...
                                <li><a href="View_File.jsp"><span data-hover="FILE_UPLOAD">FILE_UPLOAD</span></a></li>
                                <li><a href="View_Request.jsp"><span data-hover="VIEW REQUEST"class="active">VIEW REQUEST</span></a></li>
        ...
        <div class="col-sm-7 col-xs-12 contact-right">
            ...
            <div class="form-details">
                <table cellpadding="55" style="margin-left: 39%; color: white;"border="2">
                    <tr>
                    ...
                    <tr>
                        ...
                        <td><%=i.getString("Dec_Key")%></td>  
                        <td><a style ="color:white;"href="Dec_Key.jsp?cid=<%=i.getInt("fid")%>&cname=<%=i.getString("fname")%>&coname=<%=i.getString("owname")%>&cusname=<%=i.getString("usname")%>&csemikey=<%=i.getString("Sem_Dec_Key")%>">Update</a></td>
                        <%
