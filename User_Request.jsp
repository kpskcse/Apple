    ...
    <body>
                ...
                <nav class="navbar navbar-default nav-dflt-setin">
                    <div class="container">
                        ...
                        <div class="navbar-header nav-min-wid">
                            ...
                            <h1><a class="navbar-brand" href="CSP_Home.jsp">CSP</a></h1>
                        </div>
                        ...
                        <div class="collapse navbar-collapse " id="bs-example-navbar-collapse-1">
                            ...
                            <ul class="nav navbar-nav nav-max-wid cl-effect-5" id="cl-effect-5">
                                <li><a href="CSP_Home.jsp"><span data-hover="HOME">HOME</span></a></li>
                                <li><a href="User_Request.jsp"><span data-hover="USER_REQUEST" class="active">USER_REQUEST</span></a></li>
                                <li><a href="Owner_Request.jsp"><span data-hover="OWNER_REQUEST"  >OWNER_REQUEST</span></a></li>
                                <li><a href="CSP_Upload.jsp"><span data-hover="FILE_UPLOAD">FILE_UPLOAD</span></a></li>
                                <li><a href="CSP.jsp"><span data-hover="LOGOUT">LOGOUT</span></a></li>
                            </ul>
                        </div><!-- /.navbar-collapse -->
        ...
        <div class="col-sm-7 col-xs-12 contact-right">
            <%
                ...
                String query = "SELECT * FROM userreq";
                ResultSet i = db.Select(query);
            %> 

            <div class="form-details">
                <table cellpadding="55" style="margin-left: 46%; color: white;"border="2">
                    <tr>
                        <td><b>FILE_INDEX&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </b></td>
                        <td><b>FILE_CONTENT&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</b></td>
                        <td><b>OWNER_NAME&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </b></td>
                        <td><b>USER_NAME&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </b></td>                        
                        <td><b>SEMI_DEC_KEY&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; </b></td>                        
                    </tr>
                    <%
                    ...
                    <tr>
                        ...
                        <td><%=i.getString("Sem_Dec_Key")%></td>  
                        <td><a style ="color:white; "href="Semi_Key.jsp?cid=<%=i.getInt("fid")%>&cname=<%=i.getString("fname")%>&coname=<%=i.getString("owname")%>&cusname=<%=i.getString("usname")%>&csemikey=<%=i.getString("Sem_Dec_Key")%>">Update</a></td>
                        <%
